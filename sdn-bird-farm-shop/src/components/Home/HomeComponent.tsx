...
import NewBirdsCarousel from "./components/NewBirdsCarousel/NewBirdsCarousel";
import ThreeServicesBanner from "./components/ThreeServicesBanner/ThreeServicesBanner";
const itemData = [
  {
    img: BackGound1,
    title: "Bed",
  ...
  return (
    <div>
      ...
      <div className="home_body">
        ...
        <ThreeServicesBanner></ThreeServicesBanner>
      </div>
      {/* <Carousel></Carousel> */}
