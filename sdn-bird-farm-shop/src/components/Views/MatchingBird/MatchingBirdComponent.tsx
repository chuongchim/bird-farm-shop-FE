...
//Tuan Kiet fix TypeObject data 
const initialTypeID: TypeOfBirdInterface = {
    typeID: "123",      // Replace with the actual type ID
    nameType: "Parrot", // Replace with the actual bird type name
...
const MatchingBirdComponent: React.FC = () => {
    ...
    const [birdList1, setBirdList1] = React.useState<BirdInterface[] | null>(
        null
    );
