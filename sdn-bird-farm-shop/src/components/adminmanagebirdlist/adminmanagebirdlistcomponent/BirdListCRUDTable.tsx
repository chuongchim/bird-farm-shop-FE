    ...
    return (
        <Paper sx={{ width: '100%', overflow: 'hidden' }}>
            ...
            <div style={{ display: "flex" }}>
                <Autocomplete
                    onChange={(e, v) => { filtData(v as BirdInterface) }}
                    disablePortal
                    id="combo-box-demo"
                    options={data}
                    sx={{ width: 300 }}
                            ...
                            .map((row) => {
                                return (
                                    <TableRow hover role="checkbox" tabIndex={-1} key={row.productID}>
                                        ...
                                        <TableCell align='left'>
                                            <img src={row.images[0]} style={{ width: '100px', height: '100px' }}></img>
                                        </TableCell>
                                        <TableCell align='left'>
                                            {row.age}
                                        </TableCell>
                                        ...
                                        <TableCell align='left'>
                                            {row.description.length > 15 ? `${row.description.slice(0, 30)}...` : row.description}
                                        </TableCell>
                                        <TableCell align='left'>
                                            {row.price}
                                        </TableCell>
                                        ...
                                        <TableCell align='left'>
                                            <div style={{ display: "flex" }}>
                                                ...
                                                <DeleteIcon style={{ color: "red", cursor: "pointer" }} onClick={() => confirmDelete(row.productID)} />
                                            </div>
                                        </TableCell>
                                    </TableRow>
                                );
